...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/08 19:12:45 by arrudenk          #+#    #+#             */
/*   Updated: 2018/05/08 19:12:49 by arrudenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/fractol.h"

void		perpen_celtic_part2(t_fractal *set)
{
	double	x_t;
	double	y_t;
	double	temp;
	...
	{
		temp = fabs(x_t * x_t - y_t * y_t) + set->real;
